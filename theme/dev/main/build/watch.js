 ...
 * @LastEditors: Leo
 * @LastEditTime: 2022-12-09 17:05:43
 * @FilePath: \3.0-manger\build\watch.js
 */
...
exec(`cross-env process.env.SHOPIFY_STORE=${name} cross-env process.env.SHOPIFY_THEME=${branch} theme watch --dir=theme/${name}/${branch} --env=${name}`)